...
def backtest(
    ...
    try:
        ...
        log_info("---")
        result, state = run_iterations(time_series, data, window, start_date, lookback_period, strategy_wrap, collect_all_states)
        if result is None:
            return
...
def run_iterations(time_series, data, window, start_date, lookback_period, strategy, collect_all_states):
